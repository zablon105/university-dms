...
import {
  ...
  MdPerson, MdShield, MdLogin, MdLock, MdWarning, MdVisibilityOff, MdBolt
} from 'react-icons/md'
    ...
    <AuthLayout>
      <div className={`auth-layout ${isFlippingIn && !isFlipping ? 'flip-page-in' : ''} ${isFlipping ? 'flip-page-out' : ''}`.trim()} style={{ width: '100%', flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div className="auth-panel-right" style={{
          ...
          <div className="form-container" style={{ width: '100%', maxWidth: 520, padding: '48px 40px' }}>
            ...
            {/* Admin link + footer */}
            <div style={{ textAlign: 'center', marginTop: 24, padding: '16px 0', borderTop: '1px solid var(--gray-200)' }}>
              ...
              >
                <MdShield size={16} /> Administrator Login
              </a>
            </div>
